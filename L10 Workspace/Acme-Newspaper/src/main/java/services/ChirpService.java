...
public class ChirpService {
	...
	public Collection<Chirp> findChirpsByFollowedFromUser(final User u) {
		return this.chirpRepository.findChirpsByFollowedFromUserId(u.getUserAccount().getId());
	}

	public Collection<Chirp> findChirpsByUser(final User u) {
		return this.chirpRepository.findChirpsByUserId(u.getUserAccount().getId());
	}
