...
<form:form action="configuration/admin/list.do" modelAttribute="configuration">

<b><spring:message code="configuration.tabooWords"/>:&nbsp;</b><jstl:out value="${configuration.tabooWords}"/>
<br/>

<a href="configuration/admin/edit.do?configurationId=${configuration.id}">
